...
export const mockWineries: MockWinery[] = [
  ...
  { name: "Antinori", slug: "antinori", description: "26 generations of winemaking, creators of Tignanello and Solaia.", founded: 1385, owner: "Antinori Family", region: "Tuscany", country: "Italy", lat: 43.475, lng: 11.221, grapeVarieties: ["Sangiovese", "Cabernet Sauvignon"], wineStyles: ["red", "white", "rosé"], featured: true, vineyardSize: "3000 hectares", annualBottles: 20000000 },
  // RIOJA
