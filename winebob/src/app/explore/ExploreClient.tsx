...
import { Sparkles, Wine, Users, Globe, Lock, Play, Square, Satellite, Map, CloudRain, Target, Radio, PenTool, Grape, Search } from "lucide-react";
...
import type { MockWinery } from "@/data/mockWineries";
import { TourInfoCard } from "@/components/shared/TourInfoCard";
import { RegionDetailPanel } from "@/components/shared/RegionDetailPanel";
...
type RegionData = Awaited<ReturnType<typeof getRegionDetail>>;
      ...
      {selectedRegion && regionDetail && !isPending && showRegionPanel && (
        <div className="absolute right-3 z-20" style={{ top: "12%" }}>
          <RegionDetailPanel
            ...
            wines={regionDetail.wines}
            producers={regionDetail.producers}
